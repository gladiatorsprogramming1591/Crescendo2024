...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_robotDrive.setDefaultCommand(
        ...
        new RunCommand(
            () -> m_robotDrive.drive(
                -MathUtil.applyDeadband(m_driverController.getLeftY() * DriveConstants.kTeleopPercentLimit,
                    OIConstants.kDriveDeadband),
                -MathUtil.applyDeadband(m_driverController.getLeftX() * DriveConstants.kTeleopPercentLimit,
                    OIConstants.kDriveDeadband),
                -MathUtil.applyDeadband(m_driverController.getRightX() * DriveConstants.kTeleopPercentLimit,
                    OIConstants.kDriveDeadband),
                true, false),
            m_robotDrive));
  ...
  public void registerNamedCommands() {
    ...
    NamedCommands.registerCommand("AlignAndShootNote",
        new AlignAndShootNote(m_ShooterSubsystem, m_ArmSubsystem, () -> 0, () -> 0, m_robotDrive, m_IntakeSubsystem));
    ...
    NamedCommands.registerCommand("AlignAndIntake",
        new AlignAndIntake(m_ShooterSubsystem, m_ArmSubsystem, m_IntakeSubsystem, m_robotDrive).withTimeout(1.5));

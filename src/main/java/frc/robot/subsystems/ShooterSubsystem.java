...
public class ShooterSubsystem extends SubsystemBase {
  ...
  // ShooterConstants.kShooterP, ShooterConstants.kShooterI,
  // ShooterConstants.kShooterD);
  // private final SimpleMotorFeedforward m_leftShooterFeedforward =new
  // SimpleMotorFeedforward(
  // ShooterConstants.kSVolts, ShooterConstants.kVVoltSecondsPerRotation);
  // private final SimpleMotorFeedforward m_rightShooterFeedforward =new
  // SimpleMotorFeedforward(
  // ShooterConstants.kSVolts, ShooterConstants.kVVoltSecondsPerRotation);
  ...
  public void shooterOnTrap() {
    ...
    m_rightShooterMotor.getPIDController().setReference(ShooterConstants.kRightShooterTrapSpeedRPM,
        ControlType.kVelocity);
    m_leftShooterMotor.getPIDController().setReference(ShooterConstants.kLeftShooterTrapSpeedRPM,
        ControlType.kVelocity);
  }
  ...
  public void shooterOn() {
    ...
    // double leftPidOut =
    // m_leftPidController.calculate(m_leftEncoder.getVelocity()/NeoMotorConstants.kFreeSpeedRpm,m_leftTargetVelocity);
    // double rightPidOut =
    // m_rightPidController.calculate(m_rightEncoder.getVelocity()/NeoMotorConstants.kFreeSpeedRpm,m_rightTargetVelocity);
  ...
  public void transferReverse() {
    m_transferMotor.set(-0.38);
  }

  public void transferReverse(boolean slow) {
    m_transferMotor.set(slow ? -0.15 : -0.35);
  }

  @Override
  public void periodic() {
    // This method will be called once per scheduler run
    // SmartDashboard.putString("Shooter Vel", "" +
    // Math.round(m_leftEncoder.getVelocity()));
